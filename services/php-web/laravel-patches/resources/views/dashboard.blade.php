...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
        ...
        <button type="button" class="btn btn-sm btn-outline-secondary btn-hover" onclick="window.location.reload()">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm h-100 hover-card">
                <div class="card-header bg-white">
                    ...
                    <small class="text-muted">Ближайшие события</small>
                </div>
                    ...
                    @forelse ($astroEvents as $event)
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                ...
                                @php
                                    $safeDate = $event->date ? \Carbon\Carbon::parse($event->date)->setTimezone(config('app.timezone')) : null;
                                @endphp
                                @if ($safeDate)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (hasData) {
        ...
        L.marker([lat, lon]).addTo(map).bindPopup('ISS Position').openPopup();
    } else {
